...
title: Web template in depth
excerpt: While easy to get started, this template is quite complex internally. This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://prontosass.com/template-in-depth
---
